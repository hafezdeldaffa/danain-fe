<template>
  <header class="flex items-center">
    ...
    <ul class="flex items-center">
      ...
      <li>
        <nuxt-link class="text-white hover:text-teal-500 text-lg px-4 py-3" to="/projects">Project</nuxt-link>
      </li>
      <li>
        <nuxt-link class="text-white hover:text-teal-500 text-lg px-4 py-3" to="/features">Features</nuxt-link>
      </li>
      <li>
        <nuxt-link class="text-white hover:text-teal-500 text-lg px-4 py-3" to="/story">Success Stories</nuxt-link>
      </li>
    </ul>
