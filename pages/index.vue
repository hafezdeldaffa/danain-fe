        ...
        <div v-for="campaign in campaigns.data" :key="campaign.id"
          ...
          <div class="item">
            <figure class="item-image">
              <img :src="'/api/' + '/' + campaign.image_url" alt="" class="rounded-20 w-full" />
            </figure>
            <div class="item-meta">
              <h4 class="text-3xl font-medium text-gray-900 mt-5">
                {{campaign.name}}
              </h4>
              <p class="text-md font-light text-gray-900 h-15">
      ...
      <div class="flex mb-10">
        ...
        <div class="w-8/12 mt-16">
          <h2 class="text-3xl text-gray-900 font-light">
            “Funding at DanaIN is very easy and comfortable. <br />
