        ...
        <div class="mb-6">
          <div class="mb-4">
            ...
            <input type="text"
              ...
              placeholder="Write Your Name Here" value="Hafezd El Drago" />
          </div>
        </div>
        <div class="mb-6">
          <div class="mb-4">
            ...
            <input type="text"
              class="auth-form focus:outline-none focus:bg-purple-hover focus:shadow-outline focus:border-purple-hover-stroke focus:text-gray-100"
              placeholder="Write your occupation here" value="Back End Developer" />
          </div>
        </div>
        <div class="mb-6">
          <div class="mb-4">
            ...
            <input type="email"
              class="auth-form focus:outline-none focus:bg-purple-hover focus:shadow-outline focus:border-purple-hover-stroke focus:text-gray-100"
              placeholder="Write your email address here" value="el.drago@gmail.com" />
          </div>
        </div>
        <div class="mb-6">
          <div class="mb-4">
