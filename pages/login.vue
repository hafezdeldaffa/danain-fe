          ...
          <div class="mb-6">
            <div class="mb-4">
              ...
              <input type="email" v-model="login.email"
                class="auth-form focus:outline-none focus:shadow-outline focus:border-purple-hover-stroke focus:text-gray-100"
  ...
  methods: {
    async userLogin() {
      try {
        ...
        this.$auth.$storage.setUniversal('email', response.data.data.email)
